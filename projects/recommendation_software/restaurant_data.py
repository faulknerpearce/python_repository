my_categories = ['german', 'japanese', 'vegetarian', 'french', 'african', 'american', 'barbecue', 'czech', 'chinese', 'thai', 'mexican', 'indian', 'cafe', 'pizza', 'italian']

my_restaurants = [['german', "Esther's German Saloon", '3', '3', '22 Teutonic Ave.'],
                   ...
                   ['indian', 'Hindu Galore', '3', '2', '56 Park Ave'],
