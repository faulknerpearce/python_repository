...
print("\n\n******************************************************************************")
print("Welcome to the game " + str(player[0][0]) +  ". You can chose to bet on the result of a dice roll.")
remaining(player)

choice = input("\n\nWould you like to play? press(1) to play. Press(2) to exit ")
...
#i have a variable called count to prevent asking the player if they want to play when entering the loop 
    if count == 1:
        ...
        count = 1
    if int(choice) == 1: 
       prediction = input("\n\nYour call! press(1) to bet on odd. Press(2) to bet on even: ") # fix odd or even 
