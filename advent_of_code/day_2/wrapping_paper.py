...
def get_slack_and_ribbon(l, w, h):
    numbers = [l, w, h]
    bow = l * w * h
    ...
    return slack_total, ribbon_total
...
def box_dimesions(numbers):
    ...
    while i < len(numbers):
        ...
        # Calculae the slack needed
        slack, ribbon = get_slack_and_ribbon(length, width, hight)
